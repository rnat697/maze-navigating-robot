...
# Date: Sun, 18 Sep 2022 23:09:06 GMT
#set_units -time ns
...
create_generated_clock -name {timer_clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 601 1201} [list [get_pins {ClockBlock/dclk_glb_5}]]
